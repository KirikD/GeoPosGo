...
namespace ARLocation
{
    ...
    public class PlaceAtLocation : MonoBehaviour
    {
        ...
        void Initialize()
        {
            ...
            if (!hasInitialized)
            {
                ...
                if (DebugMode)
                {
                    ...
                    gameObject.GetComponent<DebugDistance>().LocatCanvasBtt = Instantiate(LocatCanvasBt, new Vector3(0, 0, 0), Quaternion.identity);
                    gameObject.GetComponent<DebugDistance>().LocatCanvasBtt.GetComponent<Canvas>().worldCamera = ARCam;
                    gameObject.GetComponent<DebugDistance>().LocatCanvasBtt.GetComponent<OpenLocationNews>().InfoIndex = InfoIndex;

                    string[] PlaceName = this.gameObject.name.Split('#'); 
                    gameObject.GetComponent<DebugDistance>().LocatCanvasBtt.transform.GetChild(0).GetChild(0).gameObject.GetComponent<Text>().text = PlaceName[1];
                    gameObject.GetComponent<DebugDistance>().DistTXT = gameObject.GetComponent<DebugDistance>().LocatCanvasBtt.transform.GetChild(0).GetChild(1).gameObject.GetComponent<Text>();
                }
        ...
        public Camera ARCam; 
        public GameObject LocatCanvasBt;
