...
namespace ARLocation.UI
{
    public class DebugDistance : MonoBehaviour
    {
        ...
        public Text DistTXT;
        public GameObject LocatCanvasBtt;
        void Update()
        {
            ...
            LocatCanvasBtt.transform.LookAt(endPos, new Vector3(0, 1, 0));
            LocatCanvasBtt.transform.Translate(new Vector3(0, 0, Vector3.Distance(startPos, endPos)*0.01f), Space.Self);
            ...
            DistTXT.text = Vector3.Distance(startPos, endPos).ToString("0.00", CultureInfo.InvariantCulture) + "m";
        }
    }
